...
function init_gear_sets()
	-- PRECAST SETS
		...
		sets.precast.JA.Spur = {main="Skullrender",feet="Nukumi Ocreae +1",back="Artio's Mantle"}
	...
	sets.precast.Flourish1['Violent Flourish'] = {
        ...
        sets.precast.FC = {
				main={name="Shukuyu's Scythe",priority=15},
				ring2="Lebeche Ring",
				ammo="Impatiens",
				neck="Voltsurge Torque",
				head={ name="Taeon Chapeau", augments={'"Fast Cast"+2',}},
				body={ name="Taeon Tabard", augments={'Attack+20','"Fast Cast"+5','VIT+10',priority=13}},
				hands="Leyline Gloves",
				back={ name="Artio's Mantle", augments={'MND+20','"Fast Cast"+10',priority=14}},
		...
		sets.precast.FC.Cure = set_combine(sets.precast.FC, {
				main={name="Shukuyu's Scythe",priority=15},
				ear2="Mendi. Earring",
				body={name="Jumalik Mail",priority=14},
				ring2="Lebeche Ring",
				ammo="Impatiens",
				neck="Voltsurge Torque",
				back={ name="Artio's Mantle", augments={'MND+20','"Fast Cast"+10',priority=13}},
				head={ name="Taeon Chapeau", augments={'"Fast Cast"+2',}},
				hands="Leyline Gloves",
				ring1="Prolix Ring",
				legs={ name="Taeon Tights", augments={'"Cure" spellcasting time -5%',}},
				feet={ name="Taeon Boots", augments={'"Fast Cast"+5',}},
				})
	...
	-- PET SIC & READY MOVES
	sets.midcast.Pet.WS = {
	main={ name="Digirbalag", augments={'"Store TP"+1','Pet: CHR+1','Pet: Accuracy+12 Pet: Rng. Acc.+12','Pet: Attack+30 Pet: Rng.Atk.+30','DMG:+3',}},
    sub="Mdomo Axe +1",
    ammo="Hesperiidae",
	...
	sets.midcast.Pet.DA = {
			...
			hands="Nukumi Manoplas +1",
			legs={ name="Valor. Hose", augments={'Pet: Attack+30 Pet: Rng.Atk.+30','Pet: "Regen"+2','System: 1 ID: 1797 Val: 5','Pet: Accuracy+14 Pet: Rng. Acc.+14',}},
			feet={ name="Valorous Greaves", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: "Dbl. Atk."+3','System: 1 ID: 1795 Val: 6','Pet: Attack+10 Pet: Rng.Atk.+10',}},
	...
	sets.midcast.Pet.MaccReady = set_combine(sets.midcast.Pet.WS, {
			...
			ear1="Enmerkar Earring",
			back={ name="Artio's Mantle", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Mag. Acc.+10',}},
			sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -2%','Pet: TP Bonus+200',}},
			ring1="Thurandaut Ring",})
	...
	sets.midcast.Pet.BreathReady = set_combine(sets.midcast.Pet.WS, {
			...
			head={ name="Valorous Mask", augments={'Pet: "Mag.Atk.Bns."+30','System: 1 ID: 1794 Val: 12','Pet: Accuracy+10 Pet: Rng. Acc.+10',}},
			body={ name="Valorous Mail", augments={'Pet: "Mag.Atk.Bns."+30','Pet: Haste+2','Pet: STR+9','Pet: Attack+7 Pet: Rng.Atk.+7',}},
			hands={ name="Valorous Mitts", augments={'Pet: "Mag.Atk.Bns."+30','Pet: Attack+5 Pet: Rng.Atk.+5',}},
			legs={ name="Valor. Hose", augments={'Pet: "Mag.Atk.Bns."+29','"Store TP"+3','System: 1 ID: 1793 Val: 4','Pet: Attack+15 Pet: Rng.Atk.+15',}},
			feet={ name="Taeon Boots", augments={'Pet: "Mag.Atk.Bns."+24','"Fast Cast"+2',}},
			--MACC
			head={ name="Valorous Mask", augments={'Pet: Mag. Acc.+30','System: 1 ID: 1794 Val: 8','Pet: Accuracy+3 Pet: Rng. Acc.+3','Pet: Attack+6 Pet: Rng.Atk.+6',}},
			body={ name="Acro Surcoat", augments={'Pet: Mag. Acc.+19',}},
			hands={ name="Valorous Mitts", augments={'Pet: Mag. Acc.+29','Pet: "Dbl. Atk."+2','Pet: Accuracy+6 Pet: Rng. Acc.+6','Pet: Attack+11 Pet: Rng.Atk.+11',}},
			legs={ name="Valor. Hose", augments={'Pet: Mag. Acc.+29','System: 1 ID: 1796 Val: 5','Pet: Accuracy+3 Pet: Rng. Acc.+3','Pet: Attack+11 Pet: Rng.Atk.+11',}},
			feet={ name="Valorous Greaves", augments={'Pet: Mag. Acc.+27','Pet: "Dbl.Atk."+1 Pet: Crit.hit rate +1','System: 1 ID: 1796 Val: 11','Pet: Attack+7 Pet: Rng.Atk.+7',}},
	...
	sets.midcast.Pet.Killer = {
			...
			ring2="Varar Ring +1",
			head="Nuk. Cabasset +1",
			body={ name="Valorous Mail", augments={'Pet: Attack+30 Pet: Rng.Atk.+30','Pet: "Subtle Blow"+6','Pet: STR+11',}},
			hands="Nukumi Manoplas +1",
			legs="Tot. Trousers +3",
			feet="Tot. Gaiters +3",
			back={ name="Artio's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Attack+10 Pet: Rng.Atk.+10','"Dbl.Atk."+10',}},
			ring1="Thurandaut Ring",
			ear1="Enmerkar Earring",
			sub={ name="Kumbhakarna", augments={'Pet: Attack+18 Pet: Rng.Atk.+18','Pet: TP Bonus+200',priority=14}},
			waist="Incarnation Sash",}		
    ...
    sets.idle = {
			...
			ear2={name="Handler's Earring +1",priority=0},
			...
			ring1="Thurandaut Ring",
			sub="Beatific Shield +1",
			back={ name="Artio's Mantle", augments={'Pet: "Regen"+10','System: 1 ID: 1246 Val: 4',}},
			waist="Isa Belt",
			ear1={name="Enmerkar Earring",priority=15}}
	...
	sets.idle.Pet = set_combine(sets.idle, {
			...
			back={ name="Artio's Mantle", augments={'Pet: "Regen"+10','System: 1 ID: 1246 Val: 4',}},
			-- MDT
	--		back={ name="Artio's Mantle", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Mag. Acc.+10','Pet: "Regen"+10','System: 1 ID: 1247 Val: 4',}},
			waist="Isa Belt",
			ear1="Enmerkar Earring",})
	...
	--		back={ name="Artio's Mantle", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Mag. Acc.+10','Pet: "Regen"+10','System: 1 ID: 1247 Val: 4',}},
		...
		-- [img]http://i.imgur.com/vCGQFNp.png[/img]
		--poop1
		--	main="Izizoeksi",
		--	head="Anwig Salade",
		--	neck="Adad Amulet",
	...
	sets.defense.Killer = set_combine(sets.defense.PDT, {body="Nukumi Gausape +1"})
	...
	sets.defense.MDT = set_combine(sets.defense.PDT, {
			...
			hands="Umuthi Gloves",
			legs="Nukumi Quijotes +1",
			feet={ name="Taeon Boots", augments={'Pet: Attack+24 Pet: Rng.Atk.+24','Pet: "Dbl. Atk."+5','Pet: Damage taken -2%',}},
			neck="Loricate Torque +1",
			waist="Nierenschutz",
			ear1="Sanare Earring",
			ear2="Merman's Earring",
	...
	sets.defense.PetMDT = set_combine(sets.defense.PDT, {
			sub="Beatific Shield +1",
			ammo="Vanir Battery",
			head={ name="Ankusa Helm +1", augments={'Enhances "Killer Instinct" effect',}},
			body={ name="An. Jackcoat +1", augments={'Enhances "Feral Howl" effect',}},
	...
	--1066 ACC
	sets.engaged = {
			main={ name="Hunahpu", augments={'Occ. atk. twice+8','Accuracy+15',}},
		--	main="Aymur",
		--	main="Tri-edge",
		--	main="Kraken Club",
			sub={ name="Beatific Shield +1", augments={'Phys. dmg. taken -4%','Spell interruption rate down -7%','Magic dmg. taken -4%',}},
		...
		--	body={ name="Valorous Mail", augments={'Enmity+1','CHR+15','Quadruple Attack +3','Accuracy+13 Attack+13',}},
			body="Jumalik Mail",
		--	hands="Tali'ah Gages +2",
			hands={ name="Valorous Mitts", augments={'Attack+29','"Dbl.Atk."+5','VIT+4','Accuracy+15',}},
		--	legs="Tali'ah Seraweels +2",
		--  legs="Meg. Chausses +2",
			legs={ name="Valor. Hose", augments={'Phys. dmg. taken -3%','Accuracy+30','Quadruple Attack +3','Mag. Acc.+4 "Mag.Atk.Bns."+4',}},
		--	feet="Tali'ah Crackows +2",
			feet={ name="Valorous Greaves", augments={'Accuracy+11 Attack+11','"Dbl.Atk."+5','DEX+9','Accuracy+13',}},
			neck="Shulmanu Collar",
			waist="Klouskap Sash",
	...
	sets.engaged.Shield = {
			...
			sub={ name="Beatific Shield +1", augments={'Phys. dmg. taken -4%','Spell interruption rate down -7%','Magic dmg. taken -4%',}},
			ammo="Staunch Tathlum",
			head={ name="Valorous Mask", augments={'Accuracy+18 Attack+18','STR+9','Accuracy+13',}},
			body="Tot. Jackcoat +3",
			hands="Meg. Gloves +2",
			legs="Meg. Chausses +1",
	...
	sets.engaged.DW = {
			...
			sub="Hunahpu",
			ammo="Ginsen",
			head={ name="Taeon Chapeau", augments={'Accuracy+23','"Dual Wield"+4',}},
			body={ name="Valorous Mail", augments={'Weapon skill damage +2%','Accuracy+28','Accuracy+19 Attack+19',}},
			hands={ name="Taeon Gloves", augments={'Accuracy+23','"Dual Wield"+4','MND+9',}},
			legs={ name="Taeon Tights", augments={'Accuracy+25','"Dual Wield"+5',}},
			feet={ name="Taeon Boots", augments={'Accuracy+20','"Dual Wield"+5',}},
			neck="Anu Torque",
			waist="Patentia Sash",
