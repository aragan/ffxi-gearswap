...
function init_gear_sets()
    ...
    head={ name="Herculean Helm", augments={'Weapon skill damage +5%','STR+7','Attack+15',}},
    body="Abnoba Kaftan",
    hands={ name="Herculean Gloves", augments={'Accuracy+29','"Store TP"+5','STR+6',}},
    legs="Hiza. Hizayoroi +2",
    feet={ name="Herculean Boots", augments={'Accuracy+23','"Store TP"+3','DEX+5',}},
    ...
    back={ name="Dispersal Mantle", augments={'STR+2','Pet: TP Bonus+480',}},
    ...
    hands={ name="Herculean Gloves", augments={'"Mag.Atk.Bns."+23','Weapon skill damage +2%',}},
    legs="Hiza. Hizayoroi +2",
    feet={ name="Herculean Boots", augments={'Weapon skill damage +5%','STR+9','Accuracy+8','Attack+8',}},
    neck={ name="Pup. Collar +2", augments={'Path: A',}},
    waist="Moonbow Belt +1",
    ...
    sets.idle.Pet.MasterDT = {    main={ name="Ohtas", augments={'Accuracy+70','Pet: Accuracy+70','Pet: Haste+10%',}},
    range="Animator P +1",
    ammo="Automat. Oil +3",
    head="Heyoka Cap",
    body={ name="Pitre Tobe +1", augments={'Enhances "Overdrive" effect',}},
